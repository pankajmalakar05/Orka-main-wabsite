...
//   const ref = useRef(null);
//   const { id } = useParams();
//   const relatedProducts = waxDetails.filter((item) => item.id !== id);
...
//     <h2 className="text-3xl md:text-4xl font-semibold text-[#5d4037] mb-12 text-center">
//       More Products
//     </h2>

//     <div className="relative">

//       {/* Left Arrow (Laptop only) */}
//       <button
//         onClick={scrollLeft}
//         className="hidden md:flex absolute -left-4 top-1/2 -translate-y-1/2 bg-white shadow-xl p-3 rounded-full z-10 hover:scale-110 transition"
//       >
//         <FaArrowLeft className="text-[#5d4037]" />
//       </button>

//       {/* Product Slider */}
//       <div
//         ref={sliderRef}
//         className="flex gap-4 md:gap-6 overflow-x-auto scroll-smooth px-2 md:px-10 py-4 scrollbar-hide"
//       >
...
//                 <h3 className="text-[#5d4037] font-semibold text-sm line-clamp-2">
//                   {item.title}
//                 </h3>

//                 <p className="font-bold text-[#3e2723] text-lg mt-2">
//                   {item.price}
//                 </p>
...
//       {/* Right Arrow (Laptop only) */}
//       <button
//         onClick={scrollRight}
//         className="hidden md:flex absolute -right-4 top-1/2 -translate-y-1/2 bg-white shadow-xl p-3 rounded-full z-10 hover:scale-110 transition"
//       >
//         <FaArrowRight className="text-[#5d4037]" />
//       </button>
